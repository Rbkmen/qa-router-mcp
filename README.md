...
Router v7 выбирает фактический выходной бюджет ниже этого потолка:
...
События Router v7 помечаются моделью, версией профиля и источником
...
Выборка из 50 оценок стратифицирована: 15 test-case, 10 log, 10 automation,
10 summary, 3 rewrite и 2 translation drafts. Маршрут перестаёт запрашивать
feedback после заполнения своей квоты. Прогресс canary считается за всё время
отдельно от семидневных generation-метрик.
